    ...
    <ul class="nav nav-pills flex-column flex-md-row mb-4 gap-2 gap-lg-0">
        <li class="nav-item">
            <a class="btn btn-danger" href="javascript:void(0);"><i
                    class="mdi mdi-account-outline mdi-20px me-1"></i>Akun</a>
        </li>
    </ul>
    <div class="card mb-1">
        ...
        <h4 class="card-header">Ubah Kata Sandi</h4>
        <div class="card-body">
                ...
                <div class="row gy-4">
                    <div class="col-md-12">
                        <div class="form-floating form-floating-outline">
                            <input class="form-control" type="password" name="current_password" id="current"
                                required />
                            <label for="current">Kata Sandi Lama</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-floating form-floating-outline">
                    ...
                    <div class="col-md-12">
                        <div class="form-floating form-floating-outline">
                            ...
                            <label for="new_confirmation">Konfirmasi Kata Sandi Baru</label>
                        </div>
                    </div>
                </div>
                <div class="mt-4">
                    <button type="submit" class="btn btn-danger me-2">Simpan Perubahan</button>
                </div>
            </form>
